        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Update Home Sectiion</li>
            </ol>
          </div> 
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
          ...
          <section class="col-md-8 offset-md-2">
           ...
           <div class="card">
              <div class="card-header" style="background-color: #086A87;color: white">
                <h5>Update Home Sectiion
                  <a  href="{{route('sections.home-view')}}" class="btn btn-warning btn-sm float-right"><i class="fa fa-list"> Home Section List</i></a>
                </h5>
              </div> 
            <div class="card-body">
                
              <form method="post" action="{{route('sections.home-update',$editdata->id)}}" id="myform"enctype="multipart/form-data">
                @csrf
                <div class="form-row">
                  ...
                  <div class="form-group col-md-6">
                    ...
                    <input type="text" name="facebook" id="facebook" class="form-control" placeholder="Enter Facebook Link" value="{{$editdata->facebook}}">
                  </div>
                  ...
                  <div class="form-group col-md-6">
                    <img id="showimage" src="{{(!empty($editdata->image))?url('backend/image/home/'.$editdata->image):url('upload/usernoimage.png')}}"
                ...
                <input type="submit" value=" Update Home Section" name="submit" class="btn btn-warning btn-block float-right" style="font-weight: bold;font-size: 18px">
                  </div>
                </div> 
              </form>
